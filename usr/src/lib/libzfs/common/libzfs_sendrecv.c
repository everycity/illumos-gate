...
static int zfs_receive_impl(libzfs_handle_t *, const char *, const char *,
    recvflags_t *, int, nvlist_t *, nvlist_t *, const char *, nvlist_t *, avl_tree_t *, char **, int,
    uint64_t *);
    ...
    uint64_t *action_handlep)
{
	...
	do {
		...
		error = zfs_receive_impl(hdl, destname, NULL, flags, fd,
		    props, limitds, sendfs, stream_nv, stream_avl, top_zfs, cleanup_fd,
		    action_handlep);
		if (error == ENODATA) {
			error = 0;
			break;
...
zfs_receive_one(libzfs_handle_t *hdl, int infd, const char *tosnap,
    const char *originsnap, recvflags_t *flags, nvlist_t *exprops, nvlist_t *limitds, dmu_replay_record_t *drr,
...
zfs_receive_impl(libzfs_handle_t *hdl, const char *tosnap,
    const char *originsnap, recvflags_t *flags, int infd, nvlist_t *props, nvlist_t *limitds, const char *sendfs,
    ...
    uint64_t *action_handlep)
{
	...
	if (DMU_GET_STREAM_HDRTYPE(drrb->drr_versioninfo) == DMU_SUBSTREAM) {
		...
		assert(DMU_GET_STREAM_HDRTYPE(drrb->drr_versioninfo) ==
		    DMU_COMPOUNDSTREAM);
		return (zfs_receive_package(hdl, infd, tosnap, flags, props, limitds,
		    &drr,
...
zfs_receive(libzfs_handle_t *hdl, const char *tosnap, nvlist_t *props,
    recvflags_t *flags, int infd, nvlist_t *props, nvlist_t *limitds, avl_tree_t *stream_avl)
{
	char *top_zfs = NULL;
	int err;
	int cleanup_fd;
	...
	err = zfs_receive_impl(hdl, tosnap, originsnap, flags, infd, props, limitds, NULL, NULL,
